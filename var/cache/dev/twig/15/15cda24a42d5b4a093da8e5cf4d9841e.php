...
class __TwigTemplate_fe8e9a19db2611891b7ab907fa1a4b7c extends Template
{
    private $source;
    private $macros = [];
...
";
 ...
 <p class=\"mb-3 mt-3 \">Pour se déconnecter c'est ici :</p> <a class=\"btn btn-sm btn-outline-danger\" href=\"";
        // line 14
...
";
    ...
    {
        return array (  105 => 14,  101 => 12,  97 => 10,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{#     - <a href=\"{{ path('account_adress') }}\">Gérer mes adresses</a> <br>
 #}     

 <p class=\"mb-3 mt-3 \">Pour se déconnecter c'est ici :</p> <a class=\"btn btn-sm btn-outline-danger\" href=\"{{ path('app_logout') }}\">Déconnexion</a>
{% endblock %}
