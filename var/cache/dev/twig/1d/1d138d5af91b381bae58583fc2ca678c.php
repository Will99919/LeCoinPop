...
/* base.html.twig */
class __TwigTemplate_e4ac585eab0f1aaeb3d0faf74b6c35d1 extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"container\">
  ...
  <div class=\"nav-scroller py-1 mb-3 border-bottom \">
    <nav class=\"nav nav-underline justify-content-evenly\">
      <a class=\"nav-item nav-link link-body-emphasis active\" href=\"{{ path('news')}}\">News</a>
      <a class=\"nav-item nav-link link-body-emphasis\" href=\"{{ path('film')}}\">Films</a>
      <a class=\"nav-item nav-link link-body-emphasis\" href=\"{{ path('serie')}}\">Séries</a>
      <a class=\"nav-item nav-link link-body-emphasis\" href=\"{{ path('contact') }}\">Contact</a>
    </nav>
  </div>
</div>
