...
class __TwigTemplate_460f5582129df217f3c176ea9b92914c extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    <button class=\"btn btn-lg btn-info btn-block mt-3 btn-sm\" type=\"submit\">
        Se connecter
    </button>
    <hr>
...
";
    ...
    {
        return array (  140 => 33,  130 => 26,  122 => 21,  117 => 18,  109 => 15,  106 => 14,  104 => 13,  101 => 12,  95 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Se connecter - Le Coin Pop{% endblock %}
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Vous etes connecté à {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Déconnexion</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\xampp\\htdocs\\le_coin_pop\\templates\\security\\login.html.twig");
    }
}
